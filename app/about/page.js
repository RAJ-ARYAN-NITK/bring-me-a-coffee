...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">About Bring me a Coffee</h1>
            <p className="text-lg mb-6">
                Bring me a Coffee is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a Coffee. Unlock the potential of your fanbase and bring your projects to life.
            </p>
